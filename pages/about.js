  ...
  render() {
    return (
      ...
      <div className="grid__row">
        ...
        <p>I'm a designer and front-end developer trying to make useful things in New Orleans, La. When I'm not at my computer I'm usually <a href="http://tarenottear.bandcamp.com/releases" target="_blank" className="txt-link">playing guitar</a> or riding my bike.</p>
        </div>
        ...
        <div className="grid__item grid__item--one-third sm-right">
          ...
          <p>I'm obsessed with the intersection of functionality and beauty. I try to use this passion to contiously better myself so that I might craft things which have a positive effect on the lives of others.</p>
        </div>
        ...
        <div className="grid__item grid__item--half ">
          <div className="wip sm-show"></div>
        <p>My passion for music has allowed me to tour half the U.S. with my best friends and meet countless inpiring people.
        </p>
        <p>These experiences not only exposed me to amazing creatives, but also to the importance of community building and cultivating relationships.
        </p>
